...
function getArtistByIndex(arry, num) {
  return `the artist at index ${num} is ${arry[num].name}`
}
console.log(artists, getArtistByIndex);
...
function removeArtist(arry, numDelete) {
  arry.splice(numDelete, 1)
  return arry.length;
}
...
function addArtist(arry) {
  arry.push({
    ...
    bio: "Master artist of web development, lives in the moment."
  });
  return arry;
}
